...
public class DataBaseAnthem extends SQLiteOpenHelper {
    ...
    private static final String INSERTION_PAYS = "INSERT INTO " + TABLE_PAYS + " (id, nom) VALUES "
            ...
            + ", (13, 'AZERBAIDJAN'), (14, 'BAHAMAS'), (15, 'BAHREIN'), (16, 'BANGLADESH'), (17, 'BARBADE'), (18, 'BELGIQUE'), (19, 'BHOUTAN')"
            + ", (20, 'BIELORUSSIE'), (21, 'BOLIVIE'), (22, 'BRESIL'), (23, 'BULGARIE'), (24, 'BURKINA_FASO'), (25, 'CAMBODGE'), (26, 'CAMEROUN'), (27, 'CANADA')"
    ...
    private static final String INSERTION_DRAPEAU = "INSERT INTO " + TABLE_DRAPEAU + " (description, id_pays) VALUES "
            ...
            + "('AZERBAIJAN', 13), ('BAHAMAS', 14), ('BAHREIN', 15), ('BANGLADESH', 16), ('BARBADOS ', 17), ('BELGIUM',18), ('BHUTAN', 19), "
            + "('BELARUS', 20), ('BOLIVIA', 21), ('BRAZIL', 22), ('BULGARIA', 23), ('BURKINA FASO', 24), ('CAMBODIA', 25), ('CAMEROON', 26), ('CANADA', 27), "
